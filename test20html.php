...
?>
	...
	<head>
		...
		<style type="text/css">
			...
			/* стрілка, що розвертається при показі категорій */
			...
			/* візуалізація списку підкатегорій */
			...
			/* поява форми при наведенні на "Кабінет" */
			...
			.wrapper-form {
				...
				border-radius: 5px;
				box-shadow: 0 0 7px #c0c0c0c0;
				transform: translate(0, 50px);
				opacity: 0;
				transition: 0.3s ease-in;
			}

			.nav>li:hover+.wrapper-form {
				opacity: 1;
			}
			...
			.form-link:first-child {
				font-weight: 600;
				border-bottom: 2px dashed #59a9ea;
			}
			...
			.form-input-checkbox:checked+.checkbox-span {
				background-image: url("https://cdn-icons-png.flaticon.com/512/1/1687.png");
					...
					<ul class="nav navbar-nav">
						...
						<div class="wrapper-form">
							<form action="#">
								<div class="wrapper-link">
									<a class="form-link" href="#">First Name</a>
									<a class="form-link" href="#">Settings</a>
								</div>
								<div class="wrapper-input">
									<div class="form-item">
										<label class="form-label" for="label">Label</label>
										<input class="form-input" id="label" type="text" placeholder="first name" name="label" tabindex="1" />
									</div>
									<div class="form-item">
										<label class="form-label" for="placeholder">Placeholder</label>
										<input class="form-input" id="placeholder" type="text" name="placeholder" tabindex="2" />
									</div>
									<div class="form-item">
										<label class="label-checkbox form-label" for="checkbox">Required</label>
										<input class="form-input-checkbox" id="checkbox" type="checkbox" tabindex="3" />
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								{
									// <!-- щоб foreach побачив глобальну змінну $categories -->
									global $categories;
									// <!-- $item - внутрішній масив -->
